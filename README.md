...
Today는 두 개의 트랙으로 나뉩니다. **1차 목표는 일상 대화 유창성**이라 기본값이며
시나리오도 가장 풍부합니다. 금융·비즈니스는 별도 시간에 의도적으로 선택하는 2차 트랙입니다.

- **Everyday (일상, 기본):** Just Talk, 하루 돌아보기, 스몰토크, 이야기하기, 의견 나누기,
  취미, 여행, 식당, 약속 잡기, 친구와 근황 등 12개 시나리오
...
| 모듈 | 역할 |
|---|---|
| **Today** | 두 트랙(Everyday/Finance)별 브리핑 생성기(전체 또는 compact/Custom-GPT), 스트릭, 복습 예정 수, 한 번 탭 복사 |
